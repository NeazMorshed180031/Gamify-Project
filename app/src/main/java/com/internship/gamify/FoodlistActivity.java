...
import com.internship.gamify.ModelClass.Cart;
import com.internship.gamify.ModelClass.Food;
            ...
            public void onClick(View v) {
                if(Utils.categoryData.getStatus().toUpperCase().equals("OPEN")) {
                    if (coun[0] > 0) {
                        ...
                        Cart cart = new Cart("Special Offer","https://iili.io/B6j97S.jpg",Utils.categoryData.getDefaultPrice(),coun[0],Utils.categoryData.getName());
                        CartList.addToCart(FoodlistActivity.this,"Special Offer",cart);
                    }
