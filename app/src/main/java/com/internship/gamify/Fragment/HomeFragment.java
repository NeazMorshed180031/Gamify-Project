package com.internship.gamify.Fragment;
...
import com.internship.gamify.CategoryActivity;
import com.internship.gamify.Constant;
import com.internship.gamify.FoodlistActivity;
import com.internship.gamify.ModelClass.Kitchen;
import com.internship.gamify.R;
...
public class HomeFragment extends Fragment {
    ...
    private class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.UserViewHolder> {
        ...
        public CategoryAdapter(Context ctx) {
            ...
            titleList.add("All");titleList.add("Dell");titleList.add("Asus");titleList.add("HP");titleList.add("acer");
        }
        @NonNull
        @Override
