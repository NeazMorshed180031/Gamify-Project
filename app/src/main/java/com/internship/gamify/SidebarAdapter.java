...
public class SidebarAdapter extends RecyclerView.Adapter<SidebarAdapter.UserViewHolder> {
    ...
    public SidebarAdapter(Context ctx, DrawerLayout drawer) {
        ...
        titleList.add("Visit our Website");titleList.add("Contact Us");titleList.add("About Us");
        iconList.add(R.drawable.ic_vendor);iconList.add(R.drawable.email);iconList.add(R.drawable.info);
        subtitleList.add("Visit as a User");subtitleList.add("Share your thought with us");subtitleList.add("About Us");
    }
    ...
    private static void performClick(Context ctx,DrawerLayout drawer,String title){
        ...
        switch (title) {
            case "Visit our Website": {
                ...
                policy.setData(Uri.parse("https://internshipgamify.netlify.app/"));
            ...
            case "Contact Us": {
                ...
                c.setData(Uri.parse("https://internshipgamify.netlify.app/contact"));
                ctx.startActivity(c);
                break;
            }
            ...
            case "About Us": {
                Intent policy = new Intent(Intent.ACTION_VIEW);
                policy.setData(Uri.parse("https://internshipgamify.netlify.app/about"));
                ctx.startActivity(policy);
                break;
            }
        }
